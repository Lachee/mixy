                ...
                if (!isset($this->definitions[$name])) {
                    ...
                    if ($props !== null) {
                        if ($props instanceof Property) { 
                            ...
                            //If the obj has a class, then resolve it.
                            $otherReferences = $obj->resolveReferences($options, $this->definitions, $depth - 1);   //Get the new references
                            if ($otherReferences !== false) {
                                $this->definitions = array_merge($this->definitions, $otherReferences);                 //Merge them back in
                            }
                            
                            //Clean them out from us   
                            $obj->definitions = [];                                                                
                        }
